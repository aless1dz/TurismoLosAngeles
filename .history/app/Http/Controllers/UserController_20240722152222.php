    ...
    public function registrar(Request $request)
    {
        ...
        $user = User::create([
         ...
         $detalles = [
            ...
            'cuerpo' => 'Hola, este es un correo de prueba para tu proyecto. Recuerda investigar los conceptos que no entiendas.',
        ];

        // Enviar el correo
        Mail::send('emails.registro_exitoso', ['detalles' => $detalles], function($message) use ($user) {
        ...
        return redirect('/iniciar-sesion')->with('status', 'Registro exitoso! Te hemos enviado un correo de bienvenida.');
