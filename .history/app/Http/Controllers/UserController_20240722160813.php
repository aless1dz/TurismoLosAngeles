...
class UserController extends Controller
{
 ...
 $correoController = new UserController();
 $correoController->enviarCorreo($user->email);
 ...
 return redirect('/iniciar-sesion')->with('message', 'Registro exitoso. Te hemos enviado un correo de bienvenida.');
    ...
    public function enviarCorreo($destinatario)
    {
        $detalles = [
            ...
            'cuerpo' => 'Hola, este es un correo de prueba. Recuerda estudiar los términos que no entiendas y preguntar al profesor si es necesario.'
        ];

        Mail::to($destinatario)->send(new RegistroExitoso($detalles));
