...
class UserController extends Controller
{
    ...
    public function enviarCorreo($destinatario)
    {
        $detalles = [
            ...
            'cuerpo' => 'Hola, este es un correo de bienvenida. Gracias por registrarte. ¡Esperamos que disfrutes de nuestro servicio!',
        ];

        Mail::send('emails.bienvenida', ['detalles' => $detalles], function ($message) use ($destinatario) {
