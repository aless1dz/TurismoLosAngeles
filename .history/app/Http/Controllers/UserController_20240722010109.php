...
class UserController extends Controller
{
    ...
    public function enviarRecuperarContrasenia(Request $request)
    {
        ...
        Mail::send('Auth.recuperar_contrasena', ['remember_token' => $remember_token], function ($message) use ($request) {
    ...
    {
        return view('Auth.actualizacion_password', ['remember_token' => $remember_token]);
    }
