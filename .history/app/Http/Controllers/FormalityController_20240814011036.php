...
$formality->form_type = $request->input('form_type', 'cita'); // Puedes cambiar 'cita' a otro valor predeterminado si es necesario
...
public function destroy($idformalities)
{
    ...
    public function viewCitasCotizaciones()
{
    $userEmail = auth()->user()->email;

    // Recuperar citas
    $citas = Formality::where('user_email', $userEmail)
                      ->where('form_type', 'cita')
                      ->get();

    // Recuperar cotizaciones
    $cotizaciones = Formality::where('user_email', $userEmail)
                             ->where('form_type', 'cotizacion')
                             ->get();

    // Pasar ambos a la vista
    return view('auth.citasCotizaciones', compact('citas', 'cotizaciones'));
}
