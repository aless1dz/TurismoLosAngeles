...
class FormalityController extends Controller
{
    ...
    {
        // Recupera las citas del usuario autenticado que sean del tipo 'visas'
        $appointments = Formality::where('form_type', 'visas')
            ->where('user_email', auth()->user()->email)
            ->get();

        // Pasa la variable $appointments a la vista 'mis_citas'
        return view('auth.citasClientes', compact('appointments'));
    }
    ...
    public function cancel($id)
    {
        ...
        // Verifica que la cita pertenece al usuario autenticado
