...
class UserController extends Controller
{
    ...
    public function registrar(Request $request)
    {
        ...
        return redirect()->route('iniciarSesionTurismoLosAngeles')->with('message', 'Registro exitoso. Te hemos enviado un correo de bienvenida.');
    }
    ...
    public function enviarCorreo($destinatario)
    {
        $detalles = [
            ...
            'cuerpo' => 'Gracias por registrarte con nosotros, estamos a tus ordenes'
        ];

        Mail::send('Auth.email_registro', ['detalles' => $detalles], function($message) use ($destinatario) {
            $message->to($destinatario)
                    ->subject('Usted esta reistrado');
