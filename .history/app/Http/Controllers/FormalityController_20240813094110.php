...
{
    $cita = Formality::find($id);
    $cita->state_form = 'aceptada';
    $cita->save();

    return redirect()->back()->with('success', 'Cita aceptada con éxito.');
}
public function cancelarCita($id)
{
    $cita = Formality::find($id);
    $cita->state_form = 'cancelada';
    $cita->save();

    return redirect()->route('ruta-para-mis-citas')->with('success', 'Cita cancelada con éxito.');
}
