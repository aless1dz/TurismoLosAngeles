...
class FormalityController extends Controller
{
    ...
    try {
        ...
        $details = [
            'user_name' => $formality->user_name,
            'user_whatsapp' => $formality->user_whatsapp,
            'user_destino' => $formality->user_destino,
            'user_date' => $formality->user_date,
            'user_pasajeros' => $formality->user_pasajeros,
            'form_type' => $formality->form_type,
        ];

        // Enviar correo a la empresa
        Mail::to('mm0673222@gmail.com')->send(new AppointmentNotification($details));
