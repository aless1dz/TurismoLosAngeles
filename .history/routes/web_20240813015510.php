...
Route::middleware('auth')->group(function () {
 ...
 Route::middleware('auth')->group(function () {
     Route::get('/mis-vistas', [FormalityController::class, 'citasClientes'])->name('auth.citasClientes');
     Route::delete('/mis-vistas/{idformalities}', [FormalityController::class, 'destroy'])->name('cancelar-cita');
 });
