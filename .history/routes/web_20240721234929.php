...
Route::get('/recuperar_contrasena', [UserController::class, 'formularioRecuperarContrasenia'])->name('recuperar-password');
...
Route::post('/actualizar-contrasenia', [UserController::class, 'actualizarContrasenia'])->name('actualizar_contrasena');
