...
// routes/web.php
Route::get('/mis-vistas', [FormalityController::class, 'myAppointments'])->name('mis-vistas');
Route::delete('/mis-vistas/{id}', [FormalityController::class, 'destroy'])->name('cancelar-cita');
