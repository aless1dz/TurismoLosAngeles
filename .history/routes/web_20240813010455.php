...
//Route::get('/citasClientes', [UserController::class, 'citasClientes']);

Route::get('/citasClientes', [FormalityController::class, 'showAppointments'])->name('mis-vistas');
Route::delete('/cancelar-cita/{id}', [FormalityController::class, 'cancel'])->name('cancel.visa');
