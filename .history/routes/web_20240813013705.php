...
// routes/web.php
Route::get('/mis-visas', [FormalityController::class, 'myAppointments'])->name('mis-vistas');
Route::delete('/mis-visas/{id}', [FormalityController::class, 'destroy'])->name('cancelar-cita');
