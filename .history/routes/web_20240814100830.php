...
Route::put('/formalities/{idformalities}/update-status-visas', [FormalityController::class, 'updateStatusVisas'])->name('formalities.updateStatusVisas');
Route::put('/formalities/{idformalities}/update-status-pasaporte', [FormalityController::class, 'updateStatusPasaporte'])->name('formalities.updateStatusPasaporte');
Route::put('/formalities/{idformalities}/update-status-rentas', [FormalityController::class, 'updateStatusRentas'])->name('formalities.updateStatusRentas');
Route::put('/formalities/{idformalities}/update-status-viajes', [FormalityController::class, 'updateStatusRentas'])->name('formalities.updateStatusRentas');
