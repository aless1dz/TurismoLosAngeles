...
Route::middleware('auth')->group(function () {
 ...
 Route::middleware('auth')->group(function () {
     Route::get('/mis-visas', [FormalityController::class, 'citasClientes'])->name('auth.citasClientes');
     Route::delete('/mis-visas/{idformalities}', [FormalityController::class, 'destroy'])->name('cancelar-cita');
 });
