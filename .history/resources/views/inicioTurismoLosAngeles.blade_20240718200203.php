...
<head>
    ...
    <title>Turismo Los Angeles</title>
...
<body>
        ...
        <header>
            <a href="/inicio-turismo-los-angeles" class="brand">TurismoLosAngeles</a>
            <div class="menu-btn"></div>
            <div class="navigation">
                <div class="navigation-items">
                    <a href="/inicio-turismo-los-angeles">Inicio</a>
                    <a href="#">Visas</a>
                    <a href="#">Galería</a>
                    <a href="#">Contacto</a>
                    <a href="/inicio-sesion-turismo-los-angeles">Iniciar Sesión</a>
                </div>
            </div>
        </header>
