...
<div class="container-fluid">
    ...
    <nav class="col-md-2 d-none d-md-block sidebar">
        ...
        <div class="col-md-10 ml-sm-auto col-lg-10 px-4">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1" class="btn btn-primary" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #0044cc; color: white; text-decoration: none; border-radius: 5px;">
                Enviar Email
            </a>
