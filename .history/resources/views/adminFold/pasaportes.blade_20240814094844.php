                ...
                <table class="table table-sm table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#updateStatusModal{{ $visa->idformalities }}">
                            ...
                            <!-- Modal -->
                <div class="modal fade" id="updateStatusModal{{ $pasaporte->idformalities }}" tabindex="-1" role="dialog" aria-labelledby="updateStatusModalLabel{{ $visa->idformalities }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('formalities.updateStatusPasaporte', $visa->idformalities) }}">
                                @csrf
                                @method('PUT')
